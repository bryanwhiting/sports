...
The home team win's probability is colored green if the model correctly predicted the home team winning. hello
...
for (mod in models){
  ...
  dt %<>% formatStyle(
    ...
    color = 'white',
    fontWeight = 'bold',
    backgroundColor = styleEqual(c(0, 1), c('transparent', green))
  ) 
}
dt
```
