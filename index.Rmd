...
description: |
  Comparing my models against 538 and some super-simple benchmarks
site: 
...
css = "background-color: #666; color: #fff;"
```
...
df %>%
  ...
  theme_minimal() + 
  labs(title='Accuracy of Model Through Season Week',
       subtitle='A score of .67 at week 5 is the accuracy of the model across weeks 1-5',
       x = 'Season Week',
       y = "Model Accuracy",
       caption = 'Source: 538')
```
